  ...
  return (
    <div >
      ...
      <h1 data-aos="flip-up" data-aos-easing="linear"
          data-aos-duration="800" style={{fontFamily:"'Philosopher', sans-serif",fontSize:"60px",fontWeight:"700" ,marginTop:"-3%",color:"white"}}>Amalraj PM</h1><br />
      <h3 style={{marginTop:"-3%"}}> <b style={{fontFamily: "font-family: 'Jost', sans-serif;",color:"white"}} >And I'm a  <span style={{color:"#fcb045"}}>MEA(<span style={{color:'white'}}>R</span>)N Stack Developer</span></b></h3><br />
